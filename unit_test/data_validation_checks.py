...
from Lead_Scoring_Data_Pipeline.unit_test.constants import *
from Lead_Scoring_Data_Pipeline.unit_test.utils import *
from Lead_Scoring_Data_Pipeline.unit_test.schema import *
...
def raw_data_schema_check():
    ...
    df_raw_data = pd.read_csv(DATA_DIRECTORY + 'leadingscoring.csv')
...
def model_input_schema_check():
    ...
    if check:
        ...
        print('Models input schema is NOT in line with schema present')
